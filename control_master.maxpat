...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 203.0, 69.0, 37.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "New=allocate a new ID number then add.  Add=tell Control to add a slider.  Set = change value of slider based on Max input.",
					"linecount" : 2,
					"numoutlets" : 0,
					"id" : "obj-30",
					"fontname" : "Helvetica",
					"fontsize" : 10.0,
					"patching_rect" : [ 669.0, 267.0, 295.0, 26.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"patching_rect" : [ 571.0, 338.0, 32.5, 16.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/control/addWidget \" {  'name': 'Slider0',  'type':'Slider',} \"",
					"numoutlets" : 1,
					"id" : "obj-32",
					"fontname" : "Helvetica",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route add new set",
					"numoutlets" : 4,
					"id" : "obj-10",
					"fontname" : "Helvetica",
					"outlettype" : [ "", "", "", "" ],
					"fontsize" : 10.0,
					"patching_rect" : [ 549.0, 269.0, 90.0, 16.0 ],
					"numinlets" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 212.5, 92.0, 249.5, 92.0 ]
				}
