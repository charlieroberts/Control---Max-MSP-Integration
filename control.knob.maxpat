...
,
		"rect" : [ 648.0, 44.0, 678.0, 289.0 ],
		"bglocked" : 0,
		"defrect" : [ 648.0, 44.0, 678.0, 289.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf remove Knob%d",
					"numinlets" : 1,
					"patching_rect" : [ 120.0, 210.0, 114.0, 16.0 ],
					"id" : "obj-35",
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf add Knob %d",
					"numinlets" : 1,
					"patching_rect" : [ 546.0, 184.0, 101.0, 16.0 ],
					"id" : "obj-26",
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf set /Knob%d %f",
					"numinlets" : 2,
					"patching_rect" : [ 375.0, 105.0, 112.0, 16.0 ],
					"id" : "obj-13",
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "js make_knob_receive.js",
					"numinlets" : 1,
					"patching_rect" : [ 120.0, 120.0, 120.0, 16.0 ],
					"id" : "obj-9",
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "new Knob",
					"numinlets" : 2,
					"patching_rect" : [ 255.0, 60.0, 55.0, 14.0 ],
					"id" : "obj-2",
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
